...
import { createReminder, deleteReminder, fetchDueReminders, fetchReminder, fetchReminders, markReminderSent, snoozeReminder, updateReminder } from './api';
const remindersKey = ['reminders'];
const reminderKey = (id) => ['reminders', id];
const dueRemindersKey = ['reminders', 'due'];
...
export function useReminderQuery(id) {
    return useQuery({
